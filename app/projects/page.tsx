              ...
              <section className="space-y-14">
                <article className="group">
                  <div className="space-y-4">
                    ...
                    <p className="page-body text-[1.02rem]">What I&rsquo;m working on now. A platform for online education and course creation.</p>
                    <div className="pt-2">
                      <a
                ...
                <article className="group">
                  <div className="space-y-4">
                    ...
                    <p className="page-body text-[1.02rem]">A previous project: an AI editing assistant for DaVinci Resolve that could see your screen and help as you edited.</p>
                    <div className="pt-2">
                      <a 

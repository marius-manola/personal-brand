...
cover: '/blog/how-to-design-an-ai-agent-memory-schema-agent-memory-four-way-hero.png'
...
![show the four storage decisions without implying a real product UI](/blog/how-to-design-an-ai-agent-memory-schema-task-state-versus-memory.png)
...
![contrast a resumable task checkpoint with a cross-task memory record](/blog/how-to-design-an-ai-agent-memory-schema-memory-categories-map.png)
...
![show the five memory categories feeding a scoped retrieval step](/blog/how-to-design-an-ai-agent-memory-schema-memory-write-validation-boundary.png)
...
![show an external-data validation boundary before any memory write](/blog/how-to-design-an-ai-agent-memory-schema-memory-promotion-gates.png)
...
![show the promotion test as a gated flow from candidate observation to scoped memory](/blog/how-to-design-an-ai-agent-memory-schema-structured-memory-record.png)
...
![explain the fields and boundaries of a structured memory record without fake UI](/blog/how-to-design-an-ai-agent-memory-schema-memory-and-source-of-truth.png)
...
![show scoped retrieval joining durable memory with current source-of-truth data before action](/blog/how-to-design-an-ai-agent-memory-schema-memory-review-and-forget-loop.png)

---
title: 'What Should an AI Agent Remember Between Tasks?'
date: '2026-08-17'
updated: '2026-08-17'
excerpt: 'A practical boundary for deciding what an AI agent should remember, recompute, reference, or forget between tasks.'
answer: 'An AI agent should remember only durable, relevant facts, confirmed preferences, validated procedures, useful past outcomes, and pointers to authoritative records. Keep current task state in a checkpoint, retrieve live system facts when they can change, and expire or delete memories that are unverified, sensitive, stale, or no longer useful.'
targetQuery: 'what should an ai agent remember between tasks'
queryAliases:
  - 'AI agent memory between tasks'
  - 'what to store in AI agent memory'
...
cover: '/blog/what-should-an-ai-agent-remember-between-tasks-agent-memory-four-way-hero.webp'
coverAlt: 'A clean editorial diagram showing an AI agent sorting information into remember, recompute, reference, and forget paths between tasks'
draft: false
---

An agent that remembers everything becomes difficult to trust. Old instructions compete with current ones, a temporary decision looks like a permanent preference, and a piece of untrusted text can come back as if the system had endorsed it.

The useful question is narrower: **will this information change how the agent should handle a future task, and can the agent prove that the information is still valid?** If the answer is no, it probably belongs in a task checkpoint, a source system, an audit log, or nowhere at all.

![show the four storage decisions without implying a real product UI](/blog/what-should-an-ai-agent-remember-between-tasks-task-state-versus-memory.webp)

## What should an AI agent remember between tasks?

An AI agent should remember durable, relevant facts, confirmed preferences, validated procedures, useful past outcomes, and pointers to authoritative records. It should keep unfinished work in resumable task state, fetch changing facts from the current system, and expire or delete memories that are unverified, sensitive, stale, or out of scope.
...
![contrast a resumable task checkpoint with a cross-task memory record](/blog/what-should-an-ai-agent-remember-between-tasks-memory-categories-map.webp)
...
![show the five memory categories feeding a scoped retrieval step](/blog/what-should-an-ai-agent-remember-between-tasks-memory-write-validation-boundary.webp)
...
![show an external-data validation boundary before any memory write](/blog/what-should-an-ai-agent-remember-between-tasks-memory-promotion-gates.webp)
...
![show the promotion test as a gated flow from candidate observation to scoped memory](/blog/what-should-an-ai-agent-remember-between-tasks-structured-memory-record.webp)
...
![explain the fields and boundaries of a structured memory record without fake UI](/blog/what-should-an-ai-agent-remember-between-tasks-memory-and-source-of-truth.webp)
...
![show scoped retrieval joining durable memory with current source-of-truth data before action](/blog/what-should-an-ai-agent-remember-between-tasks-memory-review-and-forget-loop.webp)

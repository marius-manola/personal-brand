...
cover: '/blog/what-should-an-ai-agent-remember-between-tasks-agent-memory-four-way-hero.png'
...
![show the four storage decisions without implying a real product UI](/blog/what-should-an-ai-agent-remember-between-tasks-task-state-versus-memory.png)
...
![contrast a resumable task checkpoint with a cross-task memory record](/blog/what-should-an-ai-agent-remember-between-tasks-memory-categories-map.png)
...
![show the five memory categories feeding a scoped retrieval step](/blog/what-should-an-ai-agent-remember-between-tasks-memory-write-validation-boundary.png)
...
![show an external-data validation boundary before any memory write](/blog/what-should-an-ai-agent-remember-between-tasks-memory-promotion-gates.png)
...
![show the promotion test as a gated flow from candidate observation to scoped memory](/blog/what-should-an-ai-agent-remember-between-tasks-structured-memory-record.png)
...
![explain the fields and boundaries of a structured memory record without fake UI](/blog/what-should-an-ai-agent-remember-between-tasks-memory-and-source-of-truth.png)
...
![show scoped retrieval joining durable memory with current source-of-truth data before action](/blog/what-should-an-ai-agent-remember-between-tasks-memory-review-and-forget-loop.png)

...
Marius Manolachi's service is built around making existing people capable of building AI products on their own work. That is a different promise from delivering the work for them. If your difficulty is not finding another prompt but choosing a safe capability, defining evidence, and getting feedback on a real project, [learn about working with Marius as an AI tutor or consultant](https://www.mariusmanolachi.com/learn-ai). The method in this article is complete without that step.
...
- [How to Learn AI Evaluation With a Blind Output Comparison](/blog/how-to-learn-ai-evaluation-with-a-blind-output-comparison)

...
cover: '/blog/human-in-the-loop-ai-agents-approval-boundary-hero.png'
...
![A four-part map separating training feedback, evaluation review, operational supervision, and pre-execution approval](/blog/human-in-the-loop-ai-agents-hitl-control-types.png)
...
![A decision map routing agent actions through consequence, reversibility, authority, and ambiguity into automatic, approval, human-only, or forbidden paths](/blog/human-in-the-loop-ai-agents-four-path-action-routing.png)
...
![An execution-boundary architecture separating agent proposal, deterministic policy, durable review, executor revalidation, side effect, and audit](/blog/human-in-the-loop-ai-agents-execution-boundary-architecture.png)
...
![An approval packet organized around the exact effect, material parameters, before-and-after state, evidence, policy, authority, and expiry](/blog/human-in-the-loop-ai-agents-reviewer-decision-packet.png)
...
![A parameter-binding diagram showing one frozen action digest connecting actor, tool, target version, normalized arguments, policy, reviewer decision, and executor](/blog/human-in-the-loop-ai-agents-exact-action-binding.png)
...
![An adversarial test matrix covering missing approval, parameter mutation, stale state, expiry, role failure, replay, alternate tools, dependency failure, and recovery](/blog/human-in-the-loop-ai-agents-approval-adversarial-tests.png)
...
![An operating loop connecting approval outcomes, latency, timeouts, failures, and bypass attempts to evidence review and narrow policy changes](/blog/human-in-the-loop-ai-agents-approval-operations-loop.png)

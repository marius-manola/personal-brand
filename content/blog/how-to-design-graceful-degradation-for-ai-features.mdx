...
Marius Manolachi helps existing people become capable of building AI products on their own work. If you are defining one of these contracts with a product team, the useful next step is to bring one real workflow, its current definition of done, its permissions, and the failure state you are most worried about to [AI consulting and tutoring](https://mariusmanolachi.com/learn-ai). The article is complete without that next step. The contract is the thing to use first.

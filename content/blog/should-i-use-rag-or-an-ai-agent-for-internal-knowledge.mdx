...
![Three-level architecture ladder from standard RAG to fixed workflow to an agent with retrieval and action tools](/blog/should-i-use-rag-or-an-ai-agent-for-internal-knowledge-internal-knowledge-architecture-ladder.png)

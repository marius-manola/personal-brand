...
If you want to turn the scorecard into an evaluation your team can run, [Marius Manolachi’s AI consulting and tutoring](https://mariusmanolachi.com/learn-ai) is built around making existing people capable of building AI products on their own work. The architecture decision still belongs to the people who own the workflow.

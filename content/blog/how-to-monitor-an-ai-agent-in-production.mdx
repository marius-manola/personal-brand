...
cover: "/blog/how-to-monitor-an-ai-agent-in-production-ai-agent-production-observability-hero.png"
...
![Diagram showing an AI agent run branching into model, tool, approval, handoff, and verified-effect spans](/blog/how-to-monitor-an-ai-agent-in-production-ai-agent-trace-tree.png)
...
![Conceptual diagram of five connected fields that make up an observable AI agent run](/blog/how-to-monitor-an-ai-agent-in-production-trace-contract-five-fields.png)
...
![Illustration contrasting an AI agent's claimed success with a separately verified change in the environment](/blog/how-to-monitor-an-ai-agent-in-production-agent-outcome-versus-claim.png)
...
![Conceptual diagram grouping AI agent monitoring signals into outcome, behavior, constraints, and safety](/blog/how-to-monitor-an-ai-agent-in-production-agent-observability-signal-families.png)
...
![Diagram of agent telemetry passing through a redaction boundary before reaching an observability store](/blog/how-to-monitor-an-ai-agent-in-production-agent-telemetry-redaction-boundary.png)
...
![Decision map routing AI agent monitoring signals to block, investigate, or trend responses](/blog/how-to-monitor-an-ai-agent-in-production-agent-alert-decision-matrix.png)
...
![Closed loop connecting an AI agent production incident to classification, evaluation, repair, and release](/blog/how-to-monitor-an-ai-agent-in-production-agent-incident-to-evaluation-loop.png)

  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        // Magic UI keyframes. The registry ships these as a Tailwind v4
        // `@theme inline` block in globals.css, which v3 ignores — so they live
        // here instead. Consumed by components/ui/shimmer-button.tsx and
